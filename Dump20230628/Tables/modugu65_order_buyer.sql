...
CREATE TABLE `order_buyer` (
  ...
  CONSTRAINT `order_buyer_ibfk_1` FOREIGN KEY (`buyer_id`) REFERENCES `Buyers` (`buyer_id`),
  CONSTRAINT `order_buyer_ibfk_2` FOREIGN KEY (`order_ID`) REFERENCES `orders` (`order_ID`)
...
INSERT INTO `order_buyer` VALUES ('4607316792','1'),('1464502951','2'),('2699791326','3'),('8112395969','4'),('0207403910','5');
...
-- Dump completed on 2023-06-28 20:21:12
